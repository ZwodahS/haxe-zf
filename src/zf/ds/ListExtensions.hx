...
/**
	...
	extends the haxe.ds.List with various utility
**/
@:access(haxe.ds.List)
class ListExtensions {
	...
	**/
	public static function inFilter<T>(thisList: haxe.ds.List<T>, f: T->Bool): haxe.ds.List<T> {
		var newHead = null;
		var previous = null;
	...
	**/
	public static function shuffle<T>(thisList: haxe.ds.List<T>, r: hxd.Rand = null) {
	...
	**/
	public static function contains<T>(thisList: haxe.ds.List<T>, item: T): Bool {
		for (i in thisList) {
	...
	**/
	public static function uniqueAdd<T>(thisList: haxe.ds.List<T>, item: T): Bool {
	...
	**/
	public static function firstX<T>(thisList: haxe.ds.List<T>, count: Int): Array<T> {
		var items: Array<T> = [];
		var item = thisList.h;
		for (i in 0...count) {
			if (item == null) break;
	...
	**/
	public static function get<T>(thisList: haxe.ds.List<T>, position: Int): T {
		/**
	...
	**/
	public static function popItemAtPosition<T>(thisList: haxe.ds.List<T>, position: Int): Null<T> {
		var prev = null;
		var curr = thisList.h;
		for (i in 0...position) {
			if (curr == null) break;
	...
	**/
	public static function clone<T>(thisList: haxe.ds.List<T>): haxe.ds.List<T> {
		// shallow copy
		var l = new haxe.ds.List<T>();
		for (i in thisList) {
			l.add(i);
		}
		return l;
	...
	**/
	public static function removeByFunc<T>(thisList: haxe.ds.List<T>, check: T->Bool): T {
		var found = null;
		var current = thisList.h;
		while (current != null) {
	...
	**/
	public static function toArray<T>(thisList: haxe.ds.List<T>): Array<T> {
		return [for (i in thisList) i];
	}

	public static function slice<T>(thisList: haxe.ds.List<T>, start: Int, end: Int): Array<T> {
		var i = 0;
		var curr = thisList.h;
